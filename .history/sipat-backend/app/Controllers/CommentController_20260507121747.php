...
class CommentController extends ResourceController
{
    ...
    public function create() {
        ...
        // 1. Save the actual comment (This handles the Anonymous naming publicly)
        $data = [
        ...
        // 2. 🚀 THE MASTER SYSTEM LOG (Unmasks Anonymous Users for Admin)
        if (!empty($json->user_email)) {
            ...
            // Tag it so Admin knows it was an anonymous attempt
