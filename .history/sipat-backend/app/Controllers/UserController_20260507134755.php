...
class UserController extends BaseController
{
    ...
    public function index() {
        ...
        } catch (\Exception $e) { return $this->failServerError('DB Error: ' . $e->getMessage()); }
    }
    ...
    public function toggleSaveProject() {
        ...
        $db->table('system_logs')->insert([
            'actor_email' => $json->email,
            'actor_name'  => $user['full_name'] ?: $user['organization_name'],
    ...
    public function toggleStatus() {
        ...
        try {
            ...
            $db->table('system_logs')->insert([
                ...
                'description' => "Toggled active status for user with Firebase UID '{$json->firebase_uid}'.",
                'created_at'  => date('Y-m-d H:i:s')
            ]);
