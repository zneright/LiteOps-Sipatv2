...
import ManageProjects from "./pages/agency/ManageProjects"; // 🚀 NEW: Imported the tracker page!
              ...
              <ProtectedRoute allowedRoles={["agency"]}>
                <AgencyLayout>
                  <Routes>
                    ...
                    {/* 🚀 NEW: Route added so you can visit localhost:xxxx/agency/manage-projects */}
              ...
              <ProtectedRoute allowedRoles={["citizen", "admin", "agency"]}>
                <CitizenLayout>
                  <Routes>
                    ...
                    {/* 🚀 NEW: Added the Project View route */}
                    <Route path="/projec  t/:id" element={<ProjectView />} />
