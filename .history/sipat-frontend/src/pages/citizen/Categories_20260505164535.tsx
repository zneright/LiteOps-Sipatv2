...
const categories: Category[] = [
  {
    ...
    name: "Infrastructure",
    count: 428,
    description: "Roads, bridges, and public works updates.",
    icon: "🏗️",
  ...
  },
  {
    ...
    name: "Environment",
    count: 92,
    description: "Flood control, parks, and green energy.",
    icon: "🌿",
  ...
  },
  {
    ...
    name: "Healthcare",
    count: 214,
    description: "Clinic upgrades and public health programs.",
    icon: "🏥",
  ...
  },
  {
    ...
    name: "Education",
    count: 110,
    description: "School building repairs and digital learning.",
    icon: "🎓",
  ...
  },
  {
    ...
    name: "Transport",
    count: 305,
    description: "Traffic management and public transit commits.",
    icon: "🚌",
