...
export default function CommitFeed() {
  ...
  const displayedProjects = useMemo(() => {
    ...
    if (activeTab === "Trending") sortedArray.sort((a, b) => (b.likes + b.comments) - (a.likes + a.comments));
      ...
      // 🚀 THE FIX: Now strictly filters ONLY by Agencies you follow!
      sortedArray = sortedArray.filter(p => followedAgencies.includes(p.agency));
    }
    return sortedArray;
  }, [feedData, activeTab, followedAgencies]);
