                  ...
                  return (
                    ...
                    >
                      <button
                        ...
                        className="absolute top-4 right-4 z-20 bg-rose-50/90 dark:bg-rose-900/50 backdrop-blur-md p-2.5 rounded-full shadow-lg hover:scale-110 active:scale-95 transition-all duration-300 border border-rose-200/60 dark:border-rose-700/50 hover:bg-rose-100 dark:hover:bg-rose-900/80 group/btn"
                      ...
                      <div className="p-5 md:p-6 flex flex-col flex-grow gap-3 relative z-10 bg-transparent">
                        <div>
                        ...
                        <div className="flex flex-col gap-4 mt-2 pt-4 border-t border-slate-100 dark:border-slate-800/60">
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2 bg-slate-50 dark:bg-slate-800/50 p-1.5 rounded-[1rem] border border-slate-100 dark:border-slate-700/50 shadow-sm">
                              <div className="flex items-center gap-1.5 px-2 md:px-2.5 py-1 text-[10px] md:text-[11px] font-black text-emerald-600 dark:text-emerald-400">👍 <span>{project.likes || 0}</span></div>
                              <div className="w-px h-3 bg-slate-200 dark:bg-slate-700"></div>
                              <div className="flex items-center gap-1.5 px-2 md:px-2.5 py-1 text-[10px] md:text-[11px] font-black text-slate-500 dark:text-slate-400">😐 <span>{project.neutrals || 0}</span></div>
                              <div className="w-px h-3 bg-slate-200 dark:bg-slate-700"></div>
                              <div className="flex items-center gap-1.5 px-2 md:px-2.5 py-1 text-[10px] md:text-[11px] font-black text-rose-600 dark:text-rose-400">👎 <span>{project.unlikes || 0}</span></div>
                            </div>
                          </div>
                        </div>
                      </div>
