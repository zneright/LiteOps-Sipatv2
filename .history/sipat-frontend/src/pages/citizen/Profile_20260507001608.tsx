...
export default function Profile() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto flex flex-col gap-6 sm:gap-8 pb-20 px-4 pt-4 sm:pt-8 font-sans">
      ...
      {/* 🌟 2. THE TROPHY CASE (Unlocked Badges) */}
      ...
      {/* 🌟 4. ACTIVITY FEED (Staggered Layout) */}
      ...
      {/* 🌟 EDIT MODAL (Mobile Bottom Sheet / Desktop Modal) */}
      <AnimatePresence>
        {isEditing && (
