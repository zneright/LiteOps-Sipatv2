...
interface Project {
  ...
  created_at: string;
  file_url: string;
  phases: any; // 🚀 Added phases to the interface
}
...
export default function Explore() {
  ...
  // 🚀 HELPER: Safe JSON parser for phases
  ...
  // 🚀 HELPER: Calculate Percentage and Latest Completed Phase
  const getProgressData = (phasesData: any) => {
    ...
    // Check which phases are marked completed or have an image uploaded
    ...
    // Get the title of the last completed phase, or fallback to pending
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project, idx) => {
            // 🚀 Extract progress data for this specific card
