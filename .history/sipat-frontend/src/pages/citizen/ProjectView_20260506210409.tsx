...
export default function ProjectView() {
    ...
    // 🚀 UPDATED: Sends user.email to enforce 1 vote per person
    ...
    // 🚀 NEW: Dynamically pull the dates based on what tab is active
        ...
        <div className="max-w-5xl mx-auto py-10 px-4 flex flex-col md:flex-row gap-10">
            ...
            <div className="w-full md:w-1/3 flex flex-col gap-6">
                <div>
                    ...
                    {/* 🚀 NEW: Dynamic Description (Shows project desc or phase desc depending on tab) */}
