...
Official Project Description: "${projectContext}". 
Citizen's Comment: "${userComment}". 

Task: Analyze the attached photo. 
1. Does the photo prove the official project is completed or progressing as described? Set 'match_score' from 0 (completely unrelated) to 100 (perfect proof).
2. Does the photo explicitly show an abandoned, fake, or "ghost" project (e.g., empty lots, unfinished structures, severe decay) that contradicts the official claim? Set 'is_ghost_project' to true ONLY if there is visual evidence of abandonment or fraud. Otherwise, false.
`;
