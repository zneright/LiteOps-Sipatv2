...
export default function ProjectView() {
    ...
    const orgName = project.organization_name || "DPWH"; // 🚀 Default fallback if db missing
        ...
        <div className="relative max-w-5xl mx-auto py-6 sm:py-10 px-4 flex flex-col md:flex-row gap-6 md:gap-10">
            ...
            <div className="w-full md:w-1/3 flex flex-col gap-6">
                <div>
                    ...
                    <h1 className="text-2xl sm:text-3xl font-black mb-2 break-words leading-tight">{project.title}</h1>

                    {/* 🚀 NEW: Managed By Badge */}
                    <div className="mb-5 flex items-center gap-2">
                        <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Managed By:</span>
                        <Link to={`/agency-profile/${encodeURIComponent(orgName)}`} className="inline-flex items-center gap-1.5 px-3 py-1 bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-400 rounded-lg text-xs font-black uppercase hover:bg-indigo-100 dark:hover:bg-indigo-500/20 transition-colors shadow-sm">
                            🏛️ {orgName}
                        </Link>
                    </div>
