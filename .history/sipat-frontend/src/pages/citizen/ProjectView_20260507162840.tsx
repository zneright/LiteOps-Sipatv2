                ...
                <div className="w-full xl:w-[55%] flex flex-col gap-8">
                    <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ type: "spring", bounce: 0.4 }} className="flex flex-col gap-8">
                        ...
                        <div className="w-full">
                            ...
                            <div className="flex flex-col gap-3 sm:gap-4 w-full px-2">
                                <button onClick={() => setActiveTab("Overall Project")} className={`relative flex items-center justify-between p-4 sm:p-5 w-full rounded-[1.25rem] sm:rounded-[1.5rem] transition-all duration-300 transform-gpu overflow-hidden border ${activeTab === "Overall Project" ? "text-white dark:text-slate-900 border-transparent shadow-[0_8px_20px_rgba(99,102,241,0.3)] scale-[1.02] z-10" : "bg-white/70 dark:bg-slate-900/60 backdrop-blur-xl border-white/80 dark:border-slate-700/50 text-slate-500 dark:text-slate-400 hover:bg-white dark:hover:bg-slate-800 shadow-sm hover:shadow-md hover:-translate-y-0.5"}`}>
                                    {activeTab === "Overall Project" && (
                                        <motion.div layoutId="activePhaseGrid" className="absolute inset-0 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-[1.25rem] sm:rounded-[1.5rem] -z-10" transition={{ type: "spring", bounce: 0.2, duration: 0.6 }} />
                                    )}
                                    <div className="flex items-center gap-4 sm:gap-5 relative z-10 w-full">
                                        <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center shrink-0 shadow-inner ${activeTab === "Overall Project" ? "bg-white/20 dark:bg-black/10 text-white dark:text-slate-900" : "bg-slate-100 dark:bg-slate-800 text-indigo-500"}`}>
                                        ...
                                        <div className="text-left flex-1 min-w-0">
                                            <span className={`block text-[10px] sm:text-[11px] uppercase font-black tracking-widest mb-0.5 ${activeTab === "Overall Project" ? "opacity-80" : "text-slate-400"}`}>Primary</span>
                                ...
                                {project.phases?.map((p: any, index: number) => {
                                    ...
                                    return (
                                        <button key={p.title} onClick={() => setActiveTab(p.title)} className={`relative flex items-center justify-between p-4 sm:p-5 w-full rounded-[1.25rem] sm:rounded-[1.5rem] transition-all duration-300 transform-gpu overflow-hidden border ${isActive ? "text-white dark:text-slate-900 border-transparent shadow-[0_8px_20px_rgba(99,102,241,0.3)] scale-[1.02] z-10" : "bg-white/70 dark:bg-slate-900/60 backdrop-blur-xl border-white/80 dark:border-slate-700/50 text-slate-500 dark:text-slate-400 hover:bg-white dark:hover:bg-slate-800 shadow-sm hover:shadow-md hover:-translate-y-0.5"}`}>
                                            {isActive && (
                                                <motion.div layoutId="activePhaseGrid" className="absolute inset-0 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-[1.25rem] sm:rounded-[1.5rem] -z-10" transition={{ type: "spring", bounce: 0.2, duration: 0.6 }} />
                                            )}
                                            <div className="flex items-center gap-4 sm:gap-5 relative z-10 w-full">
                                                <div className={`w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center shrink-0 text-xl sm:text-2xl font-black italic opacity-30 ${isActive ? "text-white dark:text-slate-900" : "text-slate-400"}`}>
                                                    #{index + 1}
                                                </div>
                                                ...
                                                <div className="shrink-0 flex items-center gap-2">
                                                    {isCompleted && (
                                                        <div className={`w-6 h-6 sm:w-7 sm:h-7 rounded-full flex items-center justify-center shadow-sm ${isActive ? "bg-white text-emerald-500 dark:bg-slate-900 dark:text-emerald-400" : "bg-emerald-100 text-emerald-600 dark:bg-emerald-500/20 dark:text-emerald-400"}`}>
