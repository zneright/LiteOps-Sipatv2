  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 sm:gap-8 mt-2">
        ...
        <motion.div
          variants={itemVariants}
          className="bg-gradient-to-br from-blue-600 via-indigo-600 to-indigo-800 dark:from-blue-900 dark:via-indigo-900 dark:to-slate-900 rounded-[2rem] p-8 text-white flex flex-col justify-start shadow-2xl shadow-blue-600/20 dark:shadow-none relative overflow-hidden h-full"
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-blue-100/90 text-sm font-medium leading-relaxed mt-4">
              API connections to the central citizen database are fully operational. Data sync is occurring in real-time. All systems are green and performing optimally.
            </p>
          </div>
        </motion.div>
      </div>
