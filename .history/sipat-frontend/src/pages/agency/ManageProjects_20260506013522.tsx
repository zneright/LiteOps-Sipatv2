...
export default function ManageProjects() {
    ...
    // 🚀 NEW: Tracks which project is currently clicked/expanded
    ...
    // 🚀 NEW: Manual verification (No Photo needed, usually verified by citizens)
                                    ...
                                    {isExpanded && (
                                        ...
                                        >
                                            <div className="p-6 bg-slate-50/50 dark:bg-slate-950/30">
                                                <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200 uppercase tracking-wider mb-6">Timeline & Verification</h3>
                                                            ...
                                                            <div key={index} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                                                                ...
                                                                <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-4 rounded-xl border bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700 shadow-sm transition-all hover:shadow-md text-slate-900 dark:text-slate-100">
                                                                    <div className="flex justify-between items-start mb-2">
                                                                        ...
                                                                        {/* 🚀 Manual Verify Checkbox (Citizen Override) */}
                                                                        <button
