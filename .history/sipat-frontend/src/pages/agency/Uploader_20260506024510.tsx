...
export default function Uploader() {
  ...
  const analyzeWithAI = async (selectedFile: File) => {
    ...
    try {
        ...
        properties: {
          ...
          phases: {
            ...
            items: {
              type: SchemaType.OBJECT,
              properties: {
                title: { type: SchemaType.STRING, description: "Phase name" },
                description: { type: SchemaType.STRING, description: "Phase details" },
      ...
      // 2. Pass the schema to the model
      const model = genAI.getGenerativeModel({
        model: "gemini-1.5-flash",
        generationConfig: {
          responseMimeType: "application/json",
          responseSchema: responseSchema, // Forces strict JSON keys
        }
      });

      const prompt = "Analyze the attached official public document. Extract ONLY factual data matching the JSON schema.";
      ...
      // 4. Debugging: Print to console so you can see it working!
