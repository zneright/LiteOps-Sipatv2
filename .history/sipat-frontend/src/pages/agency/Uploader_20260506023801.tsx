  ...
  const analyzeWithAI = async (selectedFile: File) => {
    ...
    try {
      ...
      const model = genAI.getGenerativeModel({
        model: "gemini-3.1-flash-litehttps://ai.google.dev/gemini-api/docs/models/gemini-3.1-flash-lite-preview#gemini-3.1-flash-lite-preview", // Fallback to 1.5-flash if 2.5 causes issues
        generationConfig: {
