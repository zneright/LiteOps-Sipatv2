                ...
                `}>
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2 sm:gap-0">
                        <div className="flex flex-col gap-0.5">
                            <Link to={`/public-profile/${encodeURIComponent(comment.author_name)}`} className="font-bold text-sm text-slate-900 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                                {comment.author_name}
                            </Link>
                                                ...
                                                <div className="flex overflow-x-auto pb-3 gap-2 snap-x custom-scrollbar">
                                                    {availableTabs.map((tab) => (
                                                        <button
                                                            ...
                                                            className={`whitespace-nowrap px-4 sm:px-5 py-2.5 rounded-xl text-xs sm:text-sm font-bold transition-all snap-start sm:snap-center focus:ring-2 focus:ring-indigo-500 focus:outline-none ${activePhase === tab
