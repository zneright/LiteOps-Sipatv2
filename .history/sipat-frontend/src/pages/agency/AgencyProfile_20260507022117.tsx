    ...
    useEffect(() => {
        const fetchDashboardData = async () => {
            ...
            try {
                ...
                // Get exactly who this agency is
                ...
                setDetails({
                    ...
                    totalProjects: agencyProjects.length // 🚀 Updated to reflect only their projects
                });
