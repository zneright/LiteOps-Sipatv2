  ...
  useEffect(() => {
    const fetchAdminStats = async () => {
      try {
        ...
        // 2. Fetch all comments (Evidence) for the entire platform
        let totalComments = 0;
        ...
        // Generate "Security Logs" based on the most recent users
    ...
    <div className="w-full max-w-7xl mx-auto flex flex-col gap-8 pb-20 pt-4 px-4 sm:px-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          { label: "Global Evidence", val: metrics.totalEvidence, icon: "📸", up: true },
        ].map((stat, i) => (
          <motion.div
            key={i}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        {/* 🚀 REAL Recent Registrations Panel */}
