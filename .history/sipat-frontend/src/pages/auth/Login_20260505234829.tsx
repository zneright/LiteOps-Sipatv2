...
export default function Login() {
  ...
  const fetchUserRole = async (uid: string) => {
    try {
      // Adjust this URL to match your actual PHP GET endpoint for fetching a user
      ...
      // If your API returns an array (e.g., [ { role: "agency" } ]), use userData[0].role
      // If your API returns an object (e.g., { role: "agency" }), use userData.role
