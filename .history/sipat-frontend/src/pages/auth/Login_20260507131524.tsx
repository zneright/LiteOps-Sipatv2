...
export default function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      else if (finalRole === "agency") navigate("/agency/dashboard");
      else navigate("/home");
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col justify-center relative overflow-hidden transition-colors duration-300 z-0 py-12">
      ...
      <div className="max-w-md w-full mx-auto px-4 sm:px-6 z-10">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-2xl p-8 rounded-[2rem] border border-white/50 dark:border-slate-700/50 shadow-2xl shadow-indigo-900/5 dark:shadow-none relative overflow-hidden">
          ...
          <form onSubmit={handleLogin} className="space-y-5 relative z-10">
            ...
            <button type="submit" disabled={isLoading} className="w-full py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold text-sm shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 transition-all duration-300 flex justify-center items-center group relative overflow-hidden">
