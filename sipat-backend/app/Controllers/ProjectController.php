    ...
    public function create()
    {
       ...
       try {
            ...
            $data = [
                ...
                'keywords'        => $json->keywords ?? null, // 🚀 catches keywords
                'start_date'      => $json->start_date ?? null, // 🚀 catches start_date
                'completion_date' => $json->completion_date ?? null, // 🚀 catches completion_date
                'phases'          => $json->phases,
