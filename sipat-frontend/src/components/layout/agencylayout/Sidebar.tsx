...
const agencyNavItems = [
  ...
  { name: "Manage Projects", path: "/agency/projects", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" },
...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-0 bg-slate-900/50 dark:bg-black/60 backdrop-blur-sm z-40 transition-opacity duration-300 lg:hidden ${
      ...
      {/* Sidebar Content */}
      <aside
        className={`fixed lg:sticky top-0 lg:top-16 left-0 z-50 h-full lg:h-[calc(100vh-4rem)] w-72 bg-slate-50 dark:bg-slate-950/50 border-r border-slate-200/60 dark:border-slate-800 flex flex-col transform transition-all duration-300 ease-in-out ${
